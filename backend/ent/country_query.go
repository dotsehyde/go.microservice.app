...
func (cq *CountryQuery) QueryUser() *UserQuery {
...
func (cq *CountryQuery) WithUser(opts ...func(*UserQuery)) *CountryQuery {
	query := (&UserClient{config: cq.config}).Query()
...
func (cq *CountryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Country, error) {
	...
	if query := cq.withUser; query != nil {
		if err := cq.loadUser(ctx, query, nodes,
			func(n *Country) { n.Edges.User = []*User{} },
			func(n *Country, e *User) { n.Edges.User = append(n.Edges.User, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CountryQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Country, init func(*Country), assign func(*Country, *User)) error {
	...
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(country.UserColumn), fks...))
	}))
