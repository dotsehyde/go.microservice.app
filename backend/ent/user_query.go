...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withCountry: uq.withCountry.Clone(),
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withCountry; query != nil {
		if err := uq.loadCountry(ctx, query, nodes, nil,
			func(n *User, e *Country) { n.Edges.Country = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadCountry(ctx context.Context, query *CountryQuery, nodes []*User, init func(*User), assign func(*User, *Country)) error {
...
func (uq *UserQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := uq.ctx.Fields; len(fields) > 0 {
		...
		if uq.withCountry != nil {
			_spec.Node.AddColumnOnce(user.FieldCountryID)
		}
	}
